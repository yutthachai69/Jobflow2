...
export const metadata = {
  title: 'รายงานการบำรุงรักษา - AirService Enterprise',
  description: 'รายงานงานบำรุงรักษา (PM) ตามสถานที่',
}

export default async function ReportsMaintenancePage() {
  ...
  return (
    <div>
      <div className="mt-4 mb-8">
          <h1 className="text-2xl font-semibold text-app-heading">รายงานการบำรุงรักษา</h1>
