...
export const metadata = {
    title: 'รายงานการติดตั้ง - Flomac Service',
    ...
    return (
        <div>
            ...
            <div className="bg-app-card rounded-xl border border-app shadow-lg overflow-hidden">
                ...
                {rows.length === 0 ? (
                    <div className="p-12 text-center text-app-muted">ยังไม่มีรายการงานติดตั้ง</div>
                ) : (
                        ...
                        <table className="w-full text-left text-sm">
                            <thead>
                                <tr className="border-b border-app bg-app-section">
                                    ...
                                    <th className="px-6 py-4 font-medium text-app-heading">อุปกรณ์ / ตำแหน่ง</th>
